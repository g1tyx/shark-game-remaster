...
var cnItems = {
    ...
    "A big-fin squid joins you.": "一条大鳍鱿鱼会加入您的行列。",
    "A bush-club squid joins you.": "丛林俱乐部鱿鱼会加入您的行列。",
    "A fire squid joins you.": "一只火鱿鱼会加入你。",
    "A flying squid joins you.": "一只会飞的鱿鱼加入你的行列。",
    "A giant squid joins you.": "一只巨大的乌贼加入你。",
    "A glacial squid joins you.": "冰川鱿鱼加入您的行列。",
    "A glass squid joins you.": "玻璃鱿鱼会加入您的行列。",
    "A grass squid joins you.": "一只草鱿鱼会加入你。",
    "A hooked squid joins you.": "一条上钩的鱿鱼会加入您的行列。",
    "A jewel squid joins you.": "宝石鱿鱼会加入您的行列。",
    "A rock-boring urchin joins you.": "一个无聊的顽童加入你。",
