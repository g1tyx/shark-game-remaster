...
var cnItems = {
    ...
    "A lemon shark joins you.": "柠檬鲨加入了你。",
    ...
    "A round stingray joins you.": "一条圆形的黄貂鱼加入了您的行列。",
    ...
    "A clownnose ray joins you.": "一条小丑鱼加入了你。",
    ...
    "A hardnose shark joins you.": "一只硬鼻鲨加入了你的行列。",
    ...
    "A sparesly-spotted stingaree joins you.": "一只零星的黄貂鱼加入了你的行列。",
    ...
    "A helmet crab joins you.": "一只头盔蟹加入了你。",
    "A lesser electric ray joins you.": "一条小电鳐加入了你。",
    ...
    "(Draw a visual aspect tree or a more accessible aspect table?)": "（画一个可视化的位面树或更易于访问的位面表？）",
    ...
    "(When using the pause button aspect, should the game not build up idle time?)": "（当使用暂停键位面，游戏不应该建立空闲时间吗？）",
    ...
    "A bluntnose stingray joins you.": "一条钝鼻黄貂鱼加入了您的行列。",
    "A cortez round stingray joins you.": "一条科尔特斯圆形黄貂鱼加入了你。",
    ...
    "Wipe Save:": "擦除存档：",
    "Wipe Settings:": "擦除设置：",
    "- Alone in the Shark -": "- 独自在鲨鱼中 -",
    "More kelp. The apples. They hunger. They hunger for kelp.": "更多海带。 苹果。 他们饥饿。 他们渴望海带。",
    "That's a lot of sharks.": "很多鲨鱼。",
    "- #TeamSeas -": "- #团队海洋 -",
    "A whole bunch of rays join you.": "一大堆鳐鱼加入了你。",
    "Construction complete.": "施工完成。",
    "Let the science commence!": "让科学开始吧！",
    "The machines rise.": "机器起来了。",
    "Beakers! Beakers underwater! It's madness!": "烧杯！ 水下烧杯！ 太疯狂了！",
    "Boil the seabed!": "把海底煮沸！",
    ...
    "into": "到",
    "for": "",
    "A foreboding circular structure, closed shut.": "一个不祥的圆形结构，封闭的。",
    "The gate beckons. The secret must be unlocked.": "大门在招手。 秘密必须被解锁。",
    "Need": "还需要",
    "One slot remains.": "还剩一个插槽。",
    "slot": "插槽",
    "more": "",
    "The slot accepts your donation and ceases to be.": "该插槽接受您的捐赠并且不再存在。",
    "The slot spits everything back out. You get the sense it wants more at once.": "插槽将所有内容吐出。 您会立即感觉到它想要更多。",
    "There are many slots, and a sign you know to mean 'insert items here'.": "有很多插槽，还有一个您知道的表示“在此处插入物品”的标志。",
    "- Five Seconds A Shark -": "- 五秒一条鲨鱼 -",
    "Churn the sand to crystal!": "把沙子搅成水晶！",
    "Crystal miners are complete.": "水晶矿工已完成。",
    "The miners dig.": "矿工们在挖。",
    "The rays are concerned.": "射线是相关的。",
    "Mining machine online.": "采矿机在线。",
    "For some reason, every slot is already filled. The structure doesn't open, though.": "由于某种原因，每个插槽都已被填满。 但是，结构并没有打开。",
    "Perhaps it needs something else.": "也许它需要别的东西。",
    "an": "一个",
    "Build auto-transmuter": "建造自动变换器",
    ...
    "Auto-transmuter constructed.": "自动变压器构造。",
    "Mystic processes automated.": "神秘的过程自动化。",
    "All is change.": "都是改变。",
    "Provide inputs. Only the output matters.": "提供输入。 只有输出很重要。",
    "A gam of sharks! Yes, that's correct.": "一群鲨鱼！ 对，那是正确的。",
    "The machines know many secrets, yet cannot speak of them.": "机器知道许多秘密，但不能说出来。",
    "Sand digger constructed.": "挖沙机已建成。",
    ...
    "eat custom": "吃掉自定义数量",
    "eat max": "全部吃掉",
    "Feed the machines. Feed them.": "喂机器。 喂他们。",
    "Recycle": "回收",
    "RESIDUE": "残渣",
    "The difference between science and magic is reliable application.": "科学与魔法的区别在于可靠的应用。",
    "All sand must be gathered.": "必须收集所有沙子。",
    "The diggers devour.": "挖掘机吞噬。",
    "The machine is online.": "机器在线。",
    "The machine acts immediately, shovelling sand.": "机器立即行动，铲沙。",
    "- Modded -": "- 改装 -",
    "- Seas of Loathing -": "- 憎恨之海 -",
    "(Maximum Level)": "（最高等级）",
    "Abandoned Ocean": "废弃的海洋",
    "Apotheosis": "神化",
    "essence": "精华",
    "Etheric force, raw and dangerous.": "以太力量，原始而危险。",
    "Gain the power to travel between worlds.": "获得在世界之间旅行的力量。",
    "It stores time from various sources.": "它存储来自各种来源的时间。",
    "Lifeblood of progress.": "进步的命脉。",
    "Manual resource collection": "手动资源收集",
    "moveable token": "可移动令牌",
    "multiplies": "倍增",
    "Path of Enlightenment": "启蒙之路",
    "production of whatever it is placed on.": "生产任何放置它的东西。",
    "Reflect upon the changes in yourself and reality you have made here.": "反思你在这里所做的你自己和现实的变化。",
    "Reflection": "反射",
    "skip": "跳过",
    "special": "特殊",
    "that": "那",
    ...
    "You may not remember everything, but you are something more than a shark now.": "你可能不记得一切，但你现在不仅仅是一条鲨鱼。",
    "A lot of crabs join you.": "很多螃蟹加入你。",
    "I can't even deal with all of these rays.": "我什至不能处理所有这些射线。",
    "Sharks for the masses. Mass sharks.": "鲨鱼群众。 大鲨鱼。",
    "A bumblebee two-spot octopus joins you.": "一只大黄蜂两点章鱼加入您的行列。",
    "A capricorn night octopus joins you.": "摩羯座夜章鱼加入你。",
    "A caribbean reef octopus joins you.": "加勒比礁章鱼加入您的行列。",
    "A carolinian octopus joins you.": "卡罗莱纳章鱼加入您的行列。",
    "A east pacific red octopus joins you.": "一只东太平洋红章鱼加入您的行列。",
    "A gloomy octopus joins you.": "一只阴沉的章鱼加入你的行列。",
    "A lilliput longarm octopus joins you.": "一只小人国长臂章鱼加入您的行列。",
    "A plain-body night octopus joins you.": "一只普通的夜章鱼加入你的行列。",
    "A scribbled night octopus joins you.": "一只夜游章鱼加入了你的行列。",
    "clam": "蛤",
    "Clam Scooping": "蚬舀",
    "clams": "蛤蜊",
    "Clams can be collected like fish.": "蛤蜊可以像鱼一样收集。",
    "collector crab": "收藏蟹",
    "collector crabs": "收藏蟹",
    ...
    "Fetch a clam. Why do we need clams now? Who knows.": "拿一只蛤蜊。为什么我们现在需要蛤蜊？谁知道。",
    "Get clam": "拿蛤蜊",
    "Got a file clam.": "得到一个文件蛤。",
    "Got a geoduck.": "有一只象拔蚌。",
    "Got a giant clam.": "得到了一个巨大的蛤蜊。",
    "Got a grooved carpet shell.": "有一个带凹槽的地毯外壳。",
    "Got a hard clam.": "有一个硬蛤蜊。",
    "Got a lyrate asiatic hard clam.": "得到了一个lyrate亚洲硬蛤。",
    "Got a manila clam.": "有一个马尼拉蛤蜊。",
    "Got a marsh clam.": "得到了一个蛤蜊。",
    "Got a pacific razor clam.": "有一个太平洋蛏子。",
    "Got a pearl oyster.": "得到了一个珍珠牡蛎。",
    "Got a peppery furrow shell.": "得到一个胡椒沟壳。",
    "Got a pismo clam.": "有一个皮斯摩蛤。",
    "Got an asiatic clam.": "有一个亚洲蛤蜊。",
    "Got an atlantic jackknife clam.": "有一个大西洋折刀蛤。",
    "Got an atlantic surf clam.": "有一个大西洋冲浪蛤。",
    ...
    "orld effects.": "世界效应。",
    "Pay an octopus for their efficient clam retrieval services.": "为章鱼提供高效的蛤蜊检索服务。",
    "pgrade effects.": "升级效果。",
    "Pried a black-ball sponge from the rocks.": "从岩石中撬出一块黑球海绵。",
    "Pried a brain sponge from the rocks.": "从岩石中撬出一块脑海绵。",
    "Pried a branching tube sponge from the rocks.": "从岩石中撬出一个分支管海绵。",
    "Pried a branching vase sponge from the rocks.": "从岩石中撬出一个分支的花瓶海绵。",
    "Pried a brown volcano carpet from the rocks.": "从岩石中撬出一块棕色的火山地毯。",
    "Pried a chicken liver sponge from the rocks.": "从岩石上撬出一块鸡肝海绵。",
    "Pried a giant barrel sponge from the rocks.": "从岩石中撬出一块巨大的海绵桶。",
    "Pried a loggerhead sponge from the rocks.": "从岩石中撬出一块红海参。",
    "Pried a red boring sponge from the rocks.": "从岩石中撬出一块红色的无聊海绵。",
    "Pried a red-orange branching sponge from the rocks.": "从岩石中撬出一块红橙色的分枝海绵。",
    "Pried a stinker sponge from the rocks.": "从岩石上撬出一块臭海绵。",
    "Pried a touch-me-not sponge from the rocks. Ow.": "从岩石上撬出一块触碰我的海绵。哦。",
    "Pried a yellow sponge from the rocks.": "从岩石中撬出一块黄色海绵。",
    "Pried an orange elephant ear sponge from the rocks.": "从岩石中撬出一块橙色的象耳海绵。",
    "Pried an orange lumpy encrusting sponge from the rocks.": "从岩石中撬出一块橙色的块状海绵。",
    "Pry sponge": "撬海绵",
    "Reassign octopus as Investigator": "将章鱼重新分配为调查员",
    "Relative time since you came through the gate:": "自您通过大门以来的相对时间：",
    "spect effects.": "观察效果。",
    "sponge": "海绵",
    ...
    "Collect and conquer. The sponges. Conquer the sponges.": "收集和征服。 海绵。 征服海绵。",
    "Delegate an octopus to investigate strange objects and phenomena for science.": "委托章鱼为科学调查奇怪的物体和现象。",
    "Each rock will have a crab, as each sponge has a rock.": "每块石头都会有一只螃蟹，就像每块海绵都有一块石头一样。",
    "Investigators will act as instructed.": "调查人员将按照指示行事。",
    "Lifeforms of pure reason.": "纯粹理性的生命形式。",
    "More octopuses join. They work in perfect unison.": "更多章鱼加入。 他们完美地协同工作。",
    "Pried a convoluted orange sponge from the rocks.": "从岩石中撬出一块盘旋的橙色海绵。",
    "Pried a strawberry vase sponge from the rocks.": "从岩石中撬出草莓花瓶海绵。",
    "Soft, porous carnivores.": "柔软、多孔的食肉动物。",
    "They hardly seem to notice you. They take their payment and begin to harvest.": "他们似乎几乎没有注意到你。 他们收了钱，开始收割。",
    "Can't dispose any more": "不能再处理了",
    "Got a duck clam.": "得到一个鸭蛤。",
    "Got a soft clam.": "得到一个软蛤蜊。",
    "Got an ark clam.": "得到一个方舟蛤。",
    "Pried a heavenly sponge from the rocks.": "从岩石中撬出一块天上的海绵。",
    "Pried a lavender rope sponge from the rocks.": "从岩石上撬出一根薰衣草绳海绵。",
    "Pried a variable boring sponge from the rocks.": "从岩石中撬出一块可变的无聊海绵。",
    "- Eel Team Six -": "- 鳗鱼六队 -",
    "Got a nut clam.": "得到一个坚果蛤蜊。",
    "Pried a brown encrusting octopus sponge from the rocks.": "从岩石中撬出一块棕色的带壳章鱼海绵。",
    "Pried a row pore rope sponge from the rocks.": "从岩石上撬出一排孔绳海绵。",
    "This crab has graduated from sponge school.": "这只螃蟹已经从海绵学校毕业了。",
    "aspects": "位面",
    "essence.": "精华。",
    "GATEWAY": "传送门",
    "Haven Ocean": "天堂海洋",
    "It is not clear how you have ended up here, but you remember a bitter defeat.": "不清楚你是如何来到这里的，但你记得一场惨痛的失败。",
    "Log cleared.": "日志已清除。",
    "Something unseen says,": "看不见的东西说，",
    "These oceans are rich with life. A thriving reef surrounds you.": "这些海洋充满了生命。 繁茂的珊瑚礁环绕着您。",
    "Time spent within last ocean:": "在最后一个海洋中花费的时间：",
    "worlds": "世界",
    ...
    "CONFIRM": "确认",
    "core aspect": "核心位面",
    "core aspect, no refunds": "核心位面，不退款",
    "COST:": "成本：",
    "ESSENCE": "本质",
    "Feels familiar.": "感觉很熟悉。",
    "Feels grimy.": "感觉很脏",
    "Feels lively.": "感觉很热闹。",
    "Focus.": "重点。",
    "MAXIMUM LEVEL.": "最高级别。",
    ...
    "proceed": "继续",
    "reconsider": "重新考虑",
    "return to gateway": "返回传送门",
    "Scout at least one world to unlock this aspect.": "侦察至少一个世界来解锁此位面。",
    "Scout at least two worlds to unlock this aspect.": "侦察至少两个世界来解锁此位面。",
    "Scout this world?": "侦察这个世界？",
    "The path begins here.": "路径从这里开始。",
    "This would grant you": "这将授予您",
    "Unlock a second token (tokens cannot stack on the same resource).": "解锁第二个令牌（令牌不能堆叠在同一资源上）。",
    "Unlock the potential of yourself.": "释放自己的潜力。",
    "WORLDS": "世界",
    "You can sense a lot of activity in this world.": "你可以感觉到这个世界上有很多活动。",
    "You're the one calling the shots, boss.": "你是那个发号施令的人，老板。",
    "Your will flows into solid shapes beyond your control.": "你的意志会变成你无法控制的实体形状。",
    "Zoom in.": "放大。",
    "Zoom out.": "缩小。",
    "This place is so familiar.": "这个地方好熟悉。",
    "This world has an aura of death and apathy.": "这个世界充满了死亡和冷漠的气息。",
    "According to your selection, you would leave": "根据您的选择，您将留下",
    "Anything that you take but don't use will be discarded.": "任何你拿走但不使用的东西都将被丢弃。",
    "confirm": "确认",
    "How much would you like to take with you to the next world?": "你想带多少东西去下一个世界？",
    "in storage.": "在存储中。",
    "left.": "剩余。",
    "ONLY TAKE AS MUCH AS YOU NEED!": "只拿你需要的！",
    "Since you're going on a scouting mission, you can take up to 10 minutes with you.": "由于您要执行侦察任务，因此您最多可以花 10 分钟时间陪伴您。",
    "THE TIME BANK": "时间银行",
    "There is": "还有",
    "with you.": "。",
    ...
    "Your metal servants can sate the hunger. The hunger for fish.": "您的金属仆人可以满足饥饿感。对鱼的饥渴。",
    "A gentle tug pulls at you.": "轻轻的拉扯拉扯着你。",
    "Change is all.": "改变就是一切。",
    "Enter gate": "进入大门",
    "Entering this place has changed you, granting you": "进入这个地方改变了你，授予你",
    "The last slot closes. The structure opens. The water glows and shimmers within it.": "最后一个插槽关闭。 结构打开。 水在其中闪闪发光。",
    ...
    "ATTRIBUTES:": "属性：",
    "Beat the world faster for extra essence.": "更快地击败世界以获得额外的精华。",
    "Frigid": "寒冷",
    "Gain -0.02": "获得 -0.02",
    "Gain 1": "获得 1",
    "hard things?": "困难的事情？",
    ...
    "per second": "每秒",
    "porous things?": "多孔的东西？",
    "production ×3.00": "产量 ×3.00",
    "Replay the Frigid World?": "重播寒冷的世界？",
    "sea urchins": "海胆",
    "something dirty?": "脏东西？",
    "squid": "乌贼",
    ...
    "aspect": "位面",
    "Become one with the lattice.": "与格子合而为一。",
    "Between worlds, have the opportunity to reroll your world selection up to": "在世界之间，有机会将您的世界选择重新滚动到",
    "Breathe. Focus. Feel the current. Control it.": "呼吸。重点。感受电流。控制它。",
    "cheaper to hire.": "租用更便宜。",
    "cheaper to produce manually.": "手工生产更便宜。",
    "Clean Slate": "干净的石板",
    "Complete the Abandoned worldtype to unlock this aspect.": "完成被遗弃的世界类型来解锁这个位面。",
    "Coordinated Cooperation": "协同合作",
    "Core frenzy members are": "核心狂热成员是",
    "count against your world-time when used.": "使用时计入您的世界时间。",
    "Crystalline Skin": "水晶皮肤",
    "Destiny Gamble": "命运赌博",
    "Distant Foresight": "远见卓识",
    "DOESN'T": "没有",
    "For each unspent": "对于每个未使用的",
    "Gain nothing now. Every time a world is completed, gain": "现在一无所获。每完成一个世界，获得",
    "gains by": "收益由",
    "Gumption": "进取心",
    "If you have less than": "如果你有少于",
    "increased by gumption).": "因进取心而增加）。",
    "Infinity Vision": "无限远景",
    "Maybe the squid had a point. Maybe teamwork really is the key.": "也许鱿鱼有道理。也许团队合作真的是关键。",
    "Meditation": "冥想",
    "Multiply the efficiency of": "倍增效率",
    "not": "不是",
    "Nothing can remain hidden to astute observers.": "对于精明的观察者来说，没有什么是隐藏的。",
    "Path of Industry": "产业之路",
    "Path of Time": "时间之路",
    "Patience": "耐心",
    ...
    "See the unseen.": "见不见。",
    "Start with": "从...开始",
    "Surely, our materials don't need to be 100% pure. Surely.": "当然，我们的材料不需要是 100% 纯的。一定。",
    "Synthetic Transmutation": "合成嬗变",
    "The Hour Hand": "时针",
    "The Minute Hand starts with": "分针以",
    "The Plan": "计划",
    "They say that good things come to those who wait.": "他们说，等待的人会得到好事。",
    "Time is a construct of the mind.": "时间是心智的构造。",
    "To build anew, you must first destroy what is already there.": "要重新建造，你必须首先摧毁已经存在的东西。",
    "Tokens increase production by": "代币增加产量",
    "Unlock a pause button to toggle idle mode at will.": "解锁暂停按钮以随意切换空闲模式。",
    "Unlock the ability to refund some aspects.": "解锁某些位面的退款能力。",
    "Unlock the potential of those around you.": "释放周围人的潜力。",
    "when entering a world. This": "当进入一个世界。这个",
    "Where we end up is all luck, but sometimes, we can stack the deck.": "我们最终的结果都是运气，但有时，我们可以堆叠甲板。",
    "you have, increase non-patience": "你有，增加不耐烦",
    "- Sharks and Recreation -": "- 鲨鱼和娱乐 -",
    "A big-fin squid joins you.": "一条大鳍鱿鱼加入了您的行列。",
    "A bush-club squid joins you.": "丛林俱乐部鱿鱼加入了您的行列。",
    "A fire squid joins you.": "一只火鱿鱼加入了你。",
    "A flying squid joins you.": "一只会飞的鱿鱼加入你的行列。",
    "A giant squid joins you.": "一只巨大的乌贼加入你。",
    "A glacial squid joins you.": "冰川鱿鱼加入您的行列。",
    "A glass squid joins you.": "玻璃鱿鱼加入了您的行列。",
    "A grass squid joins you.": "一只草鱿鱼加入了你。",
    "A hooked squid joins you.": "一条上钩的鱿鱼加入了您的行列。",
    ...
    "A flower urchin joins you.": "一个花胆加入你。",
    "A needle urchin joins you.": "一个针顽童加入你。",
    "A shoal of sharks!": "一群鲨鱼！",
    "A whip-lash squid joins you.": "鞭子鱿鱼加入了您的行列。",
    "An armhook squid joins you.": "一只臂钩乌贼加入了你的行列。",
    "ow ow ow spikes hurt": "啊啊啊啊啊啊啊啊啊刺痛",
    "The squid have no qualms about joining the frenzy.": "鱿鱼对加入狂热毫不犹豫。",
    "The squid join the frenzy, but stay close to the village.": "鱿鱼加入了狂热，但要靠近村庄。",
    "You all. Hunting duty. Get on it.": "你们。 狩猎任务。 上吧。",
    "- A New Frontier -": "- 新领域 -",
    "Add idle time": "添加放置时间",
    "All breeders are": "所有饲养员都是",
    "All machines have non-artificial-material costs reduced by": "所有机器的非人工材料成本降低",
    "Amorphous Assembly": "无定形组装",
    "ancient part": "古代部分",
    "ancientPart": "古代部分",
    "aspectAffect": "位面影响",
    "autoTransmuter": "自动转换器",
    "Beat this world immediately": "立即击败这个世界",
    "brood": "育雏",
    "cheat custom": "自定义作弊",
    "cheat custom amount of things": "作弊自定义数量的东西",
    "Cheaty Powers": "作弊的权力",
    "clam collector": "蛤蜊收集器",
    "clamCollector": "蛤蜊收藏家",
    "Collective Cooperation": "集体合作",
    "collector": "集电极",
    "Constructed Conception": "构想",
    "Cost of stuff": "东西的成本",
    "crystalMiner": "水晶矿工",
    "debug": "调试",
    "Disable number formatting": "禁用数字格式",
    "Disabled Aspects": "禁用位面",
    "Double Time": "双倍时间",
    "Doubles as a debug menu and a location for various cheats.": "兼作调试菜单和各种作弊的位置。",
    "egg": "蛋",
    "egg brooder": "育雏器",
    "eggBrooder": "育雏器",
    "Enable debug button": "启用调试按钮",
    "Enable free stuff": "启用免费的东西",
    "Enable free upgrades": "启用免费升级",
    "Enabled Aspects": "启用位面",
    "faster.": "快点。",
    "filter": "筛选",
    "fishMachine": "鱼机",
    "Freeze the game": "冻结游戏",
    "Game paused.": "游戏暂停。",
    "Game processing halted.": "游戏处理停止。",
    "Game speed": "游戏速度",
    "Gave 1 stuff.": "送了1个东西。",
    "Get all upgrades": "获得所有升级",
    "Give 1": "给 1",
    "Give 1 of Everything": "给予 1 的一切",
    "Give 1.00000e+0 of Everything": "给予 1.00000e+0 的一切",
    "Halt Execution": "暂停执行",
    "investigator": "研究者",
    "junk": "垃圾",
    "laser": "激光",
    "Make all resources exist": "让所有资源都存在",
    "maker": "制作者",
    "Mechanical Manifestation": "机械表现",
    "misc": "杂项",
    "modifiers": "修饰符",
    "multiplier": "乘数",
    "nonsense": "废话",
    "Number formatting disabled.": "数字格式已禁用。",
    "nurse": "护士",
    "octopus scavenger": "章鱼清道夫",
    "Overtime": "随着时间的推移",
    "Pause Game": "暂停游戏",
    "per second while disabled. Bonus time counts against your world-time when used.": "禁用时每秒。使用时，奖励时间会计入您的世界时间。",
    "Reduce how much machines making artificial materials consume by": "减少制造人造材料的机器的消耗量",
    "Remove 1 of Everything": "删除所有内容中的 1 个",
    "Remove 1.00000e+0 of Everything": "删除 1.00000e+0 的一切",
    "rewards.": "奖励。",
    "Roll the dice for wacky effects": "掷骰子获得古怪的效果",
    "sandDigger": "挖沙机",
    "scavenger": "清道夫",
    "scientist": "科学家",
    "sponge filter": "海绵过滤器",
    "spronge": "海绵",
    "spronge smelter": "海绵冶炼厂",
    "sprongeSmelter": "海绵冶炼厂",
    "stronger.": "更强。",
    "The Dial": "表盘",
    ...
    "Upgrade prices": "升级价格",
    "world": "世界",
    "- Shark of Darkness -": "- 黑暗之鲨 -",
    "of unused idle time with you.)": "和你未使用的放置时间。）",
    "Click to update.": "点击以更新。",
    "On it you can just make out the words": "你可以辨认出上面的字",
    "You see a new update swimming towards you.": "您会看到一个新的更新正向您游来。",
    "A strange feeling washes over you, and everything around you speeds up.": "一种奇怪的感觉席卷了你，你周围的一切都加速了。",
    "Confusion and distress overtake you as the hands of time speed up.": "随着时间之手的加速，困惑和苦恼追上了你。",
    "You breathe a sigh of relief as the world returns to normal.": "当世界恢复正常时，你松了一口气。",
    "You feel your senses return to you like the sudden snap of a rubber band.": "你感觉自己的感觉恢复了，就像橡皮筋突然被拉响一样。",
    "Your vision gets blurry. Everything is blurry. It's all a blur.": "你的视力变得模糊。一切都很模糊。一切都很模糊。",
    "An otherworldly sensation overcomes you.": "一种超凡脱俗的感觉征服了你。",
    "Clarity washes over you. You feel alert, aware, as everything goes back to normal.": "清晰的头脑会冲刷你。你感到警觉，意识到，一切都恢复正常。",
    "Everything seems to get faster.": "一切似乎都变得更快了。",
    "Frenzy members acclerate around you.": "狂乱成员在你周围加速。",
    "New Frontiers v 20220712a - The Volcanic Update": "新边疆v 20220712a -火山更新",
    "The forcible time-warp stops.": "强制的时间扭曲停止了。",
    "The hands of a nearby clock speed up.": "附近时钟的指针加快了速度。",
    "Time seems to stretch from your perspective. It feels so wrong.": "时间似乎从你的角度延伸。感觉太不对了。",
    "Time warps around you.": "时间在你身边扭曲。",
    "You are now keenly aware of what's around you as it all slows down.": "你现在敏锐地意识到你周围的一切都变慢了。",
    "You can barely understand what's happening around you anymore. The speed is jarring.": "你几乎不知道你周围发生了什么。速度是不和谐的。",
    "You come back from the brink, exhaustion replaced by energy and enthusiasm.": "你从悬崖边回来，疲惫被精力和热情所取代。",
    "You feel sluggish. Everything around you seems so much faster.": "你感到懒散。你周围的一切似乎都快了很多。",
    "You feel strange. Everything feels wrong. It's so fast.": "你觉得很奇怪。一切都感觉不对劲。它是如此之快。",
    "You feel your mind twisting. Churning. Everything seems so fast.": "你感到自己的思想在扭曲。大量生产。一切似乎都太快了。",
    "You float in place, taking in the sights as beautiful colors buzz by and the light of day flashes against night.": "你漂浮在原地，欣赏美景，美丽的色彩嗡嗡作响，白天的光线在黑夜中闪烁。",
    "You simply float right where you are, still coming to your senses.": "你只是漂浮在你所在的地方，仍然会有你的感觉。",
    "Your field of view warps significantly. Just how much were you even able to see? You can't remember.": "你的视野明显扭曲。你到底能看到多少?你不记得了。",
    "Your vision warps as time bends.": "你的视力随着时间的流逝而扭曲。",
    "What is this? What's going on? Everything feels like it's spinning.": "这是什么?这是怎么呢？一切都像是在旋转。",
    "You feel a crushing weight on your mind, and everything seems to get faster.": "你感到沉重的负担压在你的头脑上，一切似乎都变得更快了。",
    "You feel a headache coming on as time slows down again.": "时间又慢了下来，你感到头痛。",
    "You feel a weight lifting as time slows down.": "当时间慢下来时，你会感到如释重负。",
    "You feel disconnected, like you've been unplugged from the world. Time whizzes by.": "你觉得自己和世界脱节了，就像你和世界脱节了一样。时间过得飞快。",
    "You feel groggy. Everything speeds up.": "你感到昏昏沉沉。一切都加速了。",
    "You shake your head furiously, clearing the sluggishness from your mind. You feel normal again.": "你狂怒地摇了摇头，从头脑中清除了懒散。你又感觉正常了。",
    "A manta ray joins you.": "一条蝠鲼加入了你。",
    "A marbled torpedo ray joins you.": "一条大理石纹的鱼雷射线与你会合。",
    "rid 1/3 max amount of things": "去掉最多1/3的东西",
    "rid 10 amount of things": "丢弃大量的东西",
    "rid custom amount of things": "摆脱自定义数量的东西",
    "Study the bottom of the ocean to determine the rich, deep, juicy secrets it contains.": "研究海洋底部，以确定它所包含的丰富、深刻、多汁的秘密。",
    "Sure hope you know what you're doing here.": "希望你知道自己在做什么。",
    "The hunter-gatherer lifestyle will only work so well for us. Maybe we should gather these animals in one place and let them grow.": "狩猎采集的生活方式对我们来说只有这么好。也许我们应该把这些动物聚集在一个地方，让它们自己生长。",
    "The rays can now be granted gear that will let them fuse sand into crystal! Future!": "射线现在可以被授予装备，让他们把沙子融合成水晶!未来!",
    "The rays can now bother the sand more effectively, and dig up more sand now!": "现在，射线可以更有效地干扰沙子，挖出更多的沙子!",
    "The shark academies will hear of this anti-intellectual act of barbarism!": "鲨鱼学院会听到这种反智的野蛮行为的!",
    "This is a wondrous, unending source of heat! Something good must come from this.": "这是一个奇妙的，永无止境的热源!肯定会有好事发生。",
    "Thousands of sharkhours of research down the drain.": "成千上万小时的研究都付诸东流了。",
    "Using arcane shark mystery science, capture the heat of the vents for use by rays.": "利用鲨鱼的神秘科学，捕捉喷口的热量供射线使用。",
    "Well, nothing useful was determined, but if we keep on doing it we make tremendous leaps for science!": "嗯，没有确定有用的东西，但如果我们继续这样做，我们就会在科学上取得巨大的飞跃!",
    "Well, things can go into these containers that aren't water. This makes science easier!": "这些容器里可以装的不是水。这让科学变得更简单!",
    "With a new understanding of their own biology, sharks can now specialise in the manufacture of new sharks.": "有了对自身生物学的新认识，鲨鱼现在可以专门制造新的鲨鱼了。",
    "With the weird bottles, we can now put things and other things into them and see what happens.": "有了这些奇怪的瓶子，我们现在可以把东西和其他东西放进去，看看会发生什么。",
    "": "",
    "": "",
    "": "",
    "": "",
