...
SharkGame.Upgrades = {
    ...
    standardUpgrades: {
        ...
        primordialSong: {
            ...
            desc: "Even the dolphins can remember an ancient song. The whales know more, but it stirs within both of them. Perhaps we can piece it back together.",
            researchedMessage:
                "It seems that the song of the whales was only ever half of the composition. The dolphins were the key to completing it.",
            effectDesc: "The dolphins have been quieter since the gate opened. The whales seemed indifferent. The song of the ocean is older than life itself.",
            cost: {
                science: 1e7,
            },
            required: {
